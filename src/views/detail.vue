<!--<template>-->
    <!--<div>-->
        ...
        <!--<el-row type="flex" justify="center">-->
            <!--<el-col :span="5">-->
                <!--<img src="../assets/1.jpg" style="width:200px;height:280px">-->
            <!--</el-col>-->
            <!--<el-col :span="8" style="text-align: left">-->
                ...
                <!--<div>-->
                    ...
                    <!--<span class="author" style="color:#37a">{{a}}-->
                    <!--</span>-->
                ...
                <!--</div>-->
                <!--<div>-->
                   <!--官方网站:<a :href="movie.address" target="_blank">{{movie.address}}</a>-->
                <!--</div>-->
                <!--<div>-->
                ...
                <!--</div>-->
            <!--</el-col>-->
            <!--<el-col :span="5" style="border-left:1px solid lightgray;text-alian: left">-->
                <!--<h5 style="color:#4f6577">豆瓣评分</h5>-->
                <!--<div>-->
                    ...
                    <!--<div style="display: inline-block">-->
                        ...
                        <!--<div style="font-size:12px;color: #3377aa;padding-left:3px;">{{movie.scoring.amount}}评价</div>-->
                    <!--</div>-->
                    <!--<div>-->
                        <!--<el-row>-->
        ...
        <!--<el-row style="text-align: left;margin-top: 30px">-->
            <!--<el-col :span="16" :offset="4">-->
                <!--<span class="title-col" >{{movie.title}}小丑</span>的剧情简介· · · · · ·-->
            <!--</el-col>-->
        <!--</el-row>-->
        <!--<el-row style="text-align: left;margin-top: 30px">-->
            <!--<el-col :span="16" :offset="4">-->
        ...
        <!--<el-row style="text-align: left;margin-top: 30px">-->
            <!--<el-col :span="16" :offset="4">-->
                <!--<span class="title-col">{{movie.title}}小丑 </span>的短评· · · · · ·( 全部 44584 条 )-->
            <!--</el-col>-->
        <!--</el-row>-->
...
<!--<script>-->
    <!--export default {-->
        <!--//当detail.vue被加载时，首先执行created函数,实际上指的是页面未加载完成前，先执行的函数，生命周期钩子函数-->
        <!--created:function(){-->
            <!--//先给movie对象附上title的值-->
...
<template>
    <div>
        ...
        <el-row style="text-align: left;margin-top: 30px">
            <el-col :span="16" :offset="4">
                <span class="title-col">{{movie.title}}· ·短评 · · · · </span>( 全部 44584 条 )
            </el-col>
        </el-row>
        <el-row style="text-align: left;font-size: 12px" v-for="comment in movie.comments">
            <el-col :span="16" :offset="4">
